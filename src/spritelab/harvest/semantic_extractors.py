...
SEMANTIC_FAMILIES: tuple[SemanticFamily, ...] = (
    SemanticFamily(
        name="gem",
        base_objects=(
            "gem", "crystal", "diamond", "ruby", "sapphire", "amethyst", "emerald",
            "opal", "agate", "jade", "topaz", "garnet", "quartz", "pearl", "obsidian",
        ),
    ...
    SemanticFamily(
        name="food",
        base_objects=(
            "apple", "banana", "bread", "cheese", "cherry", "grape", "lemon", "orange",
            "pear", "mulberry", "strawberry", "watermelon", "pineapple", "radish",
            "carrot", "pepper", "tomato", "potato", "nut", "meat", "fish", "pie",
            "mushroom", "skewer", "egg",
        ),
    ...
    SemanticFamily(
        name="weapon",
        base_objects=(
            "sword", "dagger", "axe", "bow", "arrow", "mace", "spear", "staff", "wand",
            "gun", "cannon", "knife", "club", "whip", "scythe", "crossbow", "shuriken",
            "fist", "blade", "throwing_star",
        ),
        function=("weapon",),
    ),
    SemanticFamily(
        name="armor",
        base_objects=(
            "chestplate", "breastplate", "cuirass", "helmet", "helm", "shield",
            "boots", "shoes", "gloves", "gauntlets", "tunic", "hat", "cloak", "belt",
        ),
        function=("protection",),
    ),
    SemanticFamily(
        name="tool",
        base_objects=(
            "hammer", "pickaxe", "shovel", "compass", "ruler", "scissors", "telescope",
            "clock", "mirror", "map", "torch", "rope", "needle", "brush",
        ),
        function=("tool",),
    ),
    SemanticFamily(
        name="jewelry",
        base_objects=(
            "ring", "necklace", "amulet", "medal", "medallion", "pendant", "earring",
            "bracelet", "crown",
        ),
        function=("accessory",),
        state=("ornamental",),
    ...
    SemanticFamily(
        name="organic_part",
        base_objects=(
            "bone", "feather", "wing", "fang", "claw", "tail", "paw", "shell",
            "tentacle", "leg", "beak", "eye", "heart", "sinew", "spores", "root",
            "resin", "leaf", "clover", "ash", "scale", "fur",
        ),
        function=("crafting_material",),
        materials=("organic",),
    ),
...
EFFECT_ICON_BASES: frozenset[str] = frozenset(
    {
        "fire", "ice", "holy", "shadow", "thunder", "wind", "water", "earth",
        "poison", "magic", "buff", "physic", "light_effect", "fireball",
        "fire_spiral", "water_wave", "throw", "speed_buff",
    }
)
