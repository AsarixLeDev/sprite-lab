...
def register(subparsers: argparse._SubParsersAction) -> None:
    ...
    smoke.add_argument("--cohort", type=Path, required=True)
    smoke.add_argument("--resolved", type=Path, required=True)
    smoke.add_argument("--output-root", type=Path, default=Path("artifacts/label_v4_mock_smoke"))
    ...
    cohort.add_argument("--cohort", type=Path, required=True)
    cohort.add_argument("--resolved", type=Path, required=True)
    cohort.add_argument("--output-root", type=Path, default=Path("artifacts/label_v4_same_cohort_comparison"))
    ...
    canary.add_argument("--resolved", type=Path, required=True)
    ...
    canary.add_argument("--base-url", required=True, help="OpenAI-compatible provider base URL.")
    canary.add_argument("--api-key-env", default="SPRITELAB_VISION_API_KEY")
    ...
    prepare.add_argument("--api-key-env", default="SPRITELAB_VISION_API_KEY")
