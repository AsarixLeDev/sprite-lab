...
def default_specs() -> list[dict[str, Any]]:
    ...
    return [
        {
            "split": "train",
            "sprite_id": "t_gold_sword",
            "object_name": "golden_sword",
            "category": "weapon",
            "dominant_colors": ["gold", "yellow", "black"],
            "materials": ["metal"],
        },
        {
            "split": "train",
            "sprite_id": "t_red_potion",
        ...
        {
            "split": "train",
            "sprite_id": "t_ruby_gem",
            "object_name": "ruby_gem",
            "category": "material",
            "dominant_colors": ["red", "black"],
            "candidates": ["ruby_gem", "gem"],
        },
        {
            "split": "train",
            "sprite_id": "t_wood_shield",
            "object_name": "wooden_shield",
            "category": "armor",
            "dominant_colors": ["brown"],
        },
        {
            "split": "val",
            "sprite_id": "v_blue_vial",
            "object_name": "blue_vial",
            "category": "item_icon",
            "dominant_colors": ["blue", "white"],
        },
        {
            "split": "test",
            "sprite_id": "x_green_gem",
            "object_name": "green_gem",
            "category": "material",
