...
REQUIRES_EXTERNAL_POOL = pytest.mark.skipif(
    not POOL.is_file(),
    reason="external generated fixture datasets/sprite_lab_unlabeled_pool_v1_r2/candidate_manifest.jsonl is absent",
)
