...
def test_label_v2_sweep_prefers_highest_valid_coverage() -> None:
    ...
    records = [
        {
            "sprite_id": "a",
            "safe_prefill": {"category": "item_icon", "object_name": "apple", "confidence": 0.96},
            "filename_suggestion": {"confidence": 0.96},
            "label_quality": {"bucket": "auto_filename_trusted", "needs_review": False},
        },
        {
            "sprite_id": "b",
            "safe_prefill": {"category": "item_icon", "object_name": "orange", "confidence": 0.86},
            "filename_suggestion": {"confidence": 0.86},
            "label_quality": {"bucket": "auto_filename_trusted", "needs_review": False},
        },
    ]
    sweep = sweep_label_v2_operating_points(
        golden,
        records,
        trusted_filename_thresholds=(0.85, 0.95),
        vlm_thresholds=(0.65,),
        conflict_policies=("auto_trusted_filename_conflicts",),
    )
...
def test_label_v2_eval_reports_specificity_breakdowns() -> None:
    ...
    records = [
        {
            "sprite_id": "a",
            "safe_prefill": {"category": "armor", "object_name": "armor"},
            "label_quality": {"bucket": "auto_prefix_family_trusted", "needs_review": False},
        },
        {
            "sprite_id": "b",
            "safe_prefill": {"category": "item_icon", "object_name": "red"},
            "label_quality": {"bucket": "auto_prefix_family_trusted", "needs_review": False},
        },
        {
            "sprite_id": "c",
            "safe_prefill": {"category": "item_icon", "object_name": "ruby"},
            "label_quality": {"bucket": "auto_prefix_family_trusted", "needs_review": False},
        },
    ]
