    ...
    *,
    ...
    return {
        ...
        **values,
        ...
        "creator_lineage": f"creator:{sub_artist}",
...
def _policy(
    ...
    *,
    ...
    status = view_status or ("diagnostic" if view_name == "v5_debug" else "candidate")
    value: dict[str, Any] = {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("v5_eval_balanced", "candidate", {"supervised_strong"}),
        ("v5_source_ood", "candidate", {"supervised_strong"}),
        ("v5_open_set", "candidate", {"supervised_strong"}),
        ("v5_unlabeled", "candidate", {"unlabeled", "auxiliary_only"}),
    ],
)
